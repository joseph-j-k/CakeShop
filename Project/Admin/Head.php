    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            ...
            <span class="system-menu__title">Dashboard</span>
                ...
                <span class="system-menu__title">Operations</span>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon document" aria-hidden="true"></span>Preliminary
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon folder" aria-hidden="true"></span>Location
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon paper" aria-hidden="true"></span>Section
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="Complainttype.php">Compliant Type</a>
                        </li>
                        <li>
            ...
            <ul class="sidebar-body-menu">
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon user-3" aria-hidden="true"></span>Seller
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        ...
                        <li>
                            <a href="AcceptSeller.php">Accept Seller</a>
                        </li>
                        <li>
                            <a href="RejectSeller.php">Reject Seller</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="Logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
