...
<h1 align="center">Reject Seller</h1>
  <table border="1" align="center" class="seller-table">
    ...
    <tr>
       <?php 
	$i = 0;
	$sel = "select * from tbl_seller s inner join tbl_place p on p.place_id = s.place_id inner join tbl_district d on d.district_id = p.district_id where seller_status = '2'";
  ...
  ?>
    ...
    <td><img src="../Assets/File/Seller/<?php echo $data["seller_proof"]?>"height="50" width="25" /></td>
      ...
      <a href="ViewSeller.php?accept=<?php echo $data ["seller_id"]?>">Accept</a></td>
    </tr>
    <?php } ?>
  </table>
</form>
