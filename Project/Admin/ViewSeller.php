...
{
		$update = "update tbl_seller set seller_status = '1' where seller_id = '".$_GET["accept"]."'";
...
<h1 align="center">View Seller</h1>


  <table class="seller-table" border="1" align="center">
    <tr>
      <td>Slno</td>
      <td>Name</td>
      <td>Photo</td>
    ...
    <?php 
	$i=0;
	$sel = "select * from tbl_seller s inner join tbl_place p on p.place_id = s.place_id inner join tbl_district d on d.district_id = p.district_id where seller_status = '0'";
    ...
    <tr>
      ...
      <a href="ViewSeller.php?accept=<?php echo $data ["seller_id"]?>">Accept</a>
      <a href="ViewSeller.php?reject=<?php echo $data ["seller_id"]?>">Reject</a>
      </td>
    </tr>
     <?php } ?>
   </table>
