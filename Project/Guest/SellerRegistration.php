...
if(isset($_POST["btn_submit"]))
{
  ...
  $temp=$_FILES["Proof"]["tmp_name"];
   move_uploaded_file($temp,'../Assets/File/Seller/'.$proof);
   $question=$_POST["selQuestion"]; 
  $answer=$_POST["txt_answer"];
  
  
  $insQry="insert into tbl_seller(seller_name,seller_gender,seller_dob,seller_contact,seller_address,seller_email,seller_password,seller_photo,seller_proof,place_id,seller_squestion,seller_sanswer) values('".$name."','".$gender."','".$dob."','".$contact."','".$address."','".$email."','".$password."','".$photo."','".$proof."','".$place."','".$question."','".$answer."')";
  if($con -> query($insQry))
  {
    echo"<script>
    alert('Inserted');
...
/* Proof Upload Styles */
.proof-upload-wrapper::before {
    content: 'Choose proof';
    font-size: 16px;
    color: #ff6f61; /* Different color for proof */
    display: block;
    width: 100%;
}

.proof-upload-wrapper:hover {
    border-color: #388e3c; /* Slightly darker green for hover */
}
...
<body>
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" name="txt_dob" id="txt_dob" placeholder="YYYY-MM-DD" required autocomplete="off" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" name="txt_password" id="txt_password" placeholder="Enter your Password" required autocomplete="off"  pattern="[0-9a-zA-Z!@#$%^&*]{8,}" />
            </div>
            <div class="form-group">
                <div class="file-upload-wrapper photo-upload-wrapper">
                    <input type="file" name="photo" id="photo" required autocomplete="off"/>
                </div>
                <div id="file-preview"></div>
            </div>
            <div class="form-group">
                <div class="file-upload-wrapper proof-upload-wrapper">
                    <input type="file" name="Proof" id="Proof"  placeholder="Choose as a proof" required autocomplete="off"/>
                </div>
                <div id="file-preview"></div>
            </div>
            <div class="form-group">
