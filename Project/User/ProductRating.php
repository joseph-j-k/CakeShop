...
<head>
    ...
    <style>
    body {
        background-color: #FFF8E1; /* Dark background */
    ...
    .card-header {
        background-color:rgb(121, 183, 250); /* Header background */
        color: black; /* Header text color */
    }

    .progress {
        background-color: #333; /* Progress bar background */
    }

    .progress-bar {
        background-color: #ffc107; /* Progress bar color */
    }

    .star-light {
        color: #b0b0b0; /* Light star color */
    }

    .text-warning {
        color: #ffeb3b; /* Yellow star color */
    }

    .rounded-circle {
        background-color: #ff5722; /* User initials background */
    }
    ...
    .modal-header {
        border-bottom: 1px solid #444; /* Modal header border */
    }

    .modal-footer {
        border-top: 1px solid #444; /* Modal footer border */
    }
    ...
    .btn-primary:hover {
        ...
        border-color: #0056b3; /* Button hover border */
    }

    .progress-label-left,
    .progress-label-right {
        color: #ffffff; /* Progress label color */
    }
